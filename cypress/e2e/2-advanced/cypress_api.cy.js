...
context("Cypress APIs", () => {
  ...
  context("Cypress.config()", () => {
    ...
    it("Get and set configuration options", () => {
      ...
      // Atualizado: nossa configuração define baseUrl como 'http://localhost:3000'
      expect(myConfig).to.have.property("baseUrl", "http://localhost:3000");
      expect(myConfig).to.have.property("defaultCommandTimeout", 4000);
      expect(myConfig).to.have.property("requestTimeout", 5000);
      expect(myConfig).to.have.property("responseTimeout", 30000);
      // Atualizado: nossa configuração define viewportHeight como 720
      expect(myConfig).to.have.property("viewportHeight", 720);
      // Atualizado: nossa configuração define viewportWidth como 1280
